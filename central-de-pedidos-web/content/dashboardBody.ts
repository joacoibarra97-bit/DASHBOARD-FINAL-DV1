...
<div class="topbar">
  <div class="topbar-inner">
    ...
    <div style="display:flex;align-items:center;gap:10px;">
      <a href="/" style="font-family:'SF Mono',monospace;font-size:12px;color:#9aa3bc;text-decoration:none;margin-right:2px;">← Portal</a>
      ...
      <a href="/importar" style="font-family:'SF Mono',monospace;font-size:12px;background:rgba(255,255,255,.08);color:#fff;border:1px solid rgba(255,255,255,.18);padding:8px 14px;border-radius:100px;text-decoration:none;font-weight:700;">↑ Importar dashboard viejo</a>
