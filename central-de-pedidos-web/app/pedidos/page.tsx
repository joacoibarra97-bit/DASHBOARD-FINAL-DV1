    ...
    return (
      <div style={emptyStyles.wrap}>
        <div style={emptyStyles.card}>
          ...
          <p style={{ fontSize: 12, margin: "18px 0 0" }}><a href="/" style={{ color: "#5C6478" }}>← Volver al portal</a></p>
          <p style={{ fontSize: 12.5, color: "#5C6478", margin: "16px 0 0" }}>
            ¿Ya tenías dashboards viejos generados en el chat?{" "}
            <a href="/importar" style={{ color: "#14213D", fontWeight: 700 }}>Importalos acá</a>
          </p>
        </div>
      </div>
    );
